...
Enter your name:Pown
Year you born:1920
You are Pown. And your age is 99.
...
dct = {'name':'Pown', 'country':'India', 'city':'Tiruvannamalai', 'age':20}
print(unpacking_person_info(**dct)) # Pown lives in India, Tiruvannamalai. He is 20 years old.
```
...
print(packing_person_info(name="Pown",
      country="India", city="Tiruvannamalai", age=20))
```
...
city = Tiruvannamalai
age = 20
{'name': 'Pown', 'country': 'India', 'city': 'Tiruvannamalai', 'age': 20}
```
