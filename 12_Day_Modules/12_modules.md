...
# main.py file
import mymodule
print(mymodule.generate_full_name('Pown', 'Kumar')) # Pown Kumar
```
...
print(generate_full_name('Asabneh','Kumar'))
...
```sh
python script.py Pown 30DaysOfPython
```

The result:

```sh
Welcome Pown. Enjoy  30DayOfPython challenge! 
```
