...
4. Flatten the following list to a new list:
   ```py
   countries = [[('India', 'Tiruvannamalai')], [('Sweden', 'Stockholm')], [('Norway', 'Oslo')]]
   output:
...
6. Change the following list of lists to a list of concatenated strings:
   ```py
   names = [[('Pown', 'Kumar')], [('David', 'Smith')], [('Donald', 'Trump')], [('Bill', 'Gates')]]
   output
   ['Pown Yetaeyeh', 'David Smith', 'Donald Trump', 'Bill Gates']
   ```
