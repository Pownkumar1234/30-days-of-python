...
p = Person('Pown', 'Kumar', 20, 'India', 'Tiruvannamalai')
print(p.firstname)
print(p.lastname)
print(p.age)
print(p.country)
...
```sh
# output
Pown Kumar is 20 years old. He lives in Tiruvannamalai, India
```
...
```py
class Person:
      def __init__(self, firstname='Pown', lastname='Kumar', age=20, country='India', city='Tiruvannamalai'):
          self.firstname = firstname
          self.lastname = lastname
          self.age = age
          self.country = country
...
s1 = Student('Eyob', 'Kumar', 30, 'India', 'Tiruvannamalai')
...
```sh
output
Eyob Kumar is 30 years old. He lives in Tiruvannamalai, India.
...
```py
class Student(Person):
    def __init__ (self, firstname='Pown', lastname='Kumar',age=20, country='India', city='Tiruvannamalai', gender='male'):
        self.gender = gender
...
s1 = Student('Eyob', 'Kumar', 30, 'India', 'Tiruvannamalai','male')
