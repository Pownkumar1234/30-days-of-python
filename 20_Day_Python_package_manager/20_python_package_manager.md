...
```sh
asabeneh@Pown:~$ pip install numpy
```
...
```sh
asabeneh@Pown:~$ pip install pandas
```
...
url_lists = [
    ...
    'https://github.com/Pown',
    'https://twitter.com/Pown',
]
...
```sh
asabeneh@Pown:~$ pip show --verbose pandas
Name: pandas
Version: 1.2.3
Summary: Powerful data structures for data analysis, time series, and statistics
Home-page: http://pandas.pydata.org
...
```py
asabeneh@Pown:~$ pip install requests
```
...
```sh
asabeneh@Pown:~/Desktop/30DaysOfPython$ python
Python 3.9.6 (default, Jun 28 2021, 15:26:21)
[Clang 11.0.0 (clang-1100.0.33.8)] on darwin
Type "help", "copyright", "credits" or "license" for more information.
...
>>> greet.greet_person('Pown', 'Kumar')
'Pown Kumar, welcome to 30DaysOfPython Challenge!'
>>>
```
