...
```py
 lst = ['Pown', 20, True, {'country':'India', 'city':'Tiruvannamalai'}] # list containing different data types
```
...
1. Find the middle country(ies) in the [countries list](https://github.com/Pown/30-Days-Of-Python/tree/master/data/countries.py)
