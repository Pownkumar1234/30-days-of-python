...
```python
dct = {'name':'Pown','country':'India','city':'Tiruvannamalai'}
```
...
```python
data = {'Name': ['Pown', 'David', 'John'], 'Country':[
...
```python
data = [
    {'Name': 'Pown', 'Country': 'India', 'City': 'Tiruvannamalai'},
...
```sh
curl -O https://raw.githubusercontent.com/Pown/30-Days-Of-Python/master/data/weight-height.csv
```
