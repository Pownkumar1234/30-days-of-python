...
```sh
asabeneh@Pown:~$ pip install virtualenv
```
...
For Mac/Linux:
```sh
asabeneh@Pown:~/Desktop/30DaysOfPython/flask_project\$ virtualenv venv
...
```sh
asabeneh@Pown:~/Desktop/30DaysOfPython/flask_project$ ls
venv/
```
...
For Mac/Linux:
```sh
asabeneh@Pown:~/Desktop/30DaysOfPython/flask_project$ source venv/bin/activate
```
...
```sh
(venv) asabeneh@Pown:~/Desktop/30DaysOfPython/flask_project$
```
...
```sh
(venv) asabeneh@Pown:~/Desktop/30DaysOfPython/flask_project$ pip install Flask
```

Now, let us write pip freeze to see a list of installed packages in the project:

```sh
(venv) asabeneh@Pown:~/Desktop/30DaysOfPython/flask_project$ pip freeze
Click==7.0
Flask==1.1.1
itsdangerous==1.1.0
Jinja2==2.10.3
...
```sh
(venv) asabeneh@Pown:~/Desktop/30DaysOfPython$ deactivate
```
