...
def generate_full_name (first_name, last_name):
    space = ' '
      full_name = first_name + space + last_name
      return full_name
print('Full Name: ', generate_full_name('Pown','Kumar'))
...
def print_fullname(firstname, lastname):
    ...
    print(full_name)
print(print_fullname(firstname = 'Pown', lastname = 'Kumar'))
...
def print_name(firstname):
    return firstname
print_name('Pown') # Pown

def print_full_name(firstname, lastname):
    space = ' '
    full_name = firstname  + space + lastname
    return full_name
print_full_name(firstname='Pown', lastname='Kumar')
```
...
def generate_full_name (first_name = 'Pown', last_name = 'Kumar'):
    space = ' '
    full_name = first_name + space + last_name
    return full_name
...
def generate_groups (team,*args):
    ...
    for i in args:
        print(i)
print(generate_groups('Team-1','Pown','Brook','David','Eyob'))
```
...
Now it is time to express your thoughts about the Author and 30DaysOfPython. You can leave your testimonial on this
## 💻 Exercises: Day 11
